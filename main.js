...
function addUser(){
	...
	var print ='<div class="row" id="data'+counter+'" style="margin-bottom:15px">'+
			   '<div class="col-md-6 col-sm-12 col-xs-12">'+
			   '<input type="text" class="form-control" value="'+inputdata+'" disabled >'+
			   '</div>'+
			   '<div class="col-md-2 col-sm-4 col-xs-4">'+
			   '<button class="btn btn-success" type="button" onclick="edit(this.id)" id="edit'+counter+'">Edit</button>'+
			   '</div>'+
			   '<div class="col-md-2 col-sm-4 col-xs-4">'+
			   '<button class="btn btn-success" type="button" onclick="update(this.id)" id="update'+counter+'">Update</button>'+
			   '</div>'+
			   '<div class="col-md-2 col-sm-4 col-xs-4">'+
			   '<button class="btn btn-danger" type="button" onclick="remove(this.id)" id="delete'+counter+'">Delete</button>'+
			   '</div>'+
		       '</div>';
